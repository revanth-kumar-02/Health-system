...
import { Stethoscope, LogOut, User, Calendar, Award, Building, LayoutDashboard, ChevronDown, Settings, HelpCircle } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-teal-100/60 shadow-sm h-20 flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex items-center justify-between h-full">
          ...
          {/* User profile controls & Dropdown */}
            ...
            {user ? (
              <>
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 text-slate-400 transition-transform duration-300 ${dropdownOpen ? 'rotate-185' : ''}`} />
                </button>
